...
namespace personelOtomasyon.Data.Controllers
{
            ...
            if (user != null)
            {
                ...
                if (passwordCheck)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        if (await _userManager.IsInRoleAsync(user, UserRoles.Yonetici))
                            return RedirectToAction("Dashboard", "Yonetici");

                        if (await _userManager.IsInRoleAsync(user, UserRoles.Juri))
